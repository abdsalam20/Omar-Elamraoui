      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="space-y-4">
             ...
             <div className="space-y-4">
              ...
              <p className={theme.textBody}>
                Faculty of Sciences and Technologies of Settat<br/>
                University Hassan First<br/>
                Settat, Morocco<br/>
                <a href="http://www.fsts.uh1.ac.ma/" target="_blank" rel="noopener noreferrer" className={`${theme.textLink} ${theme.textLinkHover}`}>Faculty Website</a>
              </p>
            </div>
          </div>
        ...
        <div className="mt-16 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
           ...
           <div className={`rounded-lg shadow-lg overflow-hidden ${theme.card}`}>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3336.195034177435!2d-7.618642524317134!3d33.0003059809919!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xda6056580543557%3A0x6b75a7f5d9d3a58b!2sFaculty%20of%20Sciences%20and%20Technologies%20of%20Settat!5e0!3m2!1sen!2sma!4v1721836528761!5m2!1sen!2sma"
              width="100%"
              height="450"
              style={{ border: 0 }}
              ...
              title="Faculty of Sciences and Technologies of Settat Location"
            ></iframe>
           </div>
        </div>
      </div>
